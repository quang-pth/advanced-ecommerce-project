            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="sidebar-widget hot-deals wow fadeInUp outer-bottom-xs">
                    ...
                    <div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
                        ...
                        @endforeach <!-- end hot_deals foreach-->
                    </div>
                    <!-- /.sidebar-widget -->
                </div>
                <!-- ============================================== HOT DEALS: END ============================================== -->
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            @php
                                $idx = 0;
                            @endphp
                            @while($idx < count($specialOfferProducts))
                            <div class="item">
                                <div class="products special-product">
                                    @for($row = 0; $row < 3  && $idx < count($specialOfferProducts); $row++)
                                        @php
                                            $product = $specialOfferProducts[$idx++];
                                        @endphp
{{--                                    each product on each row--}}
                                        <div class="product">
                    ...
                    <div class="sidebar-widget-body outer-top-xs">
                        <div class="owl-carousel sidebar-carousel special-offer custom-carousel owl-theme outer-top-xs">
                            @php
                                $idx = 0;
                            @endphp
                            @while($idx < count($specialDealProducts))
                                <div class="item">
                                    <div class="products special-product">
                                        @for($row = 0; $row < 3  && $idx < count($specialDealProducts); $row++)
                                            @php
                                                $product = $specialDealProducts[$idx++];
                                            @endphp
                                            <div class="product">
                                                <div class="product-micro">
                                                    <div class="row product-micro-row">
                                            ...
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a href="{{ url('product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                            <img  src="{{ $product->product_thumbnail }}" alt=""></a>
                                                    </div>
                                                    <!-- /.image -->
                                                    @php
                                                        $amount = $product->selling_price - $product->discount_price;
...
{{--                        category-based product --}}
                        ...
                        <div class="tab-pane" id="category{{$category->id}}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                    @php
                                        $cateWiseProduct = $category->product->sortByDesc('id');
                                    @endphp
                ...
                <!-- /.section -->
                @foreach($categorizedProducts as $categorizedProduct)
                <!-- ============================================== SKIP PRODUCT   PRODUCTS : START ============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'vietnamese' && !empty($categorizedProduct->first()))
                            {{ $categorizedProduct->first()->category->category_name_vn }}
                        @elseif (!empty($categorizedProduct->first()))
                            {{ $categorizedProduct->first()->category->category_name_en }}
                        @endif
                        </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
                        @foreach($categorizedProduct as $product)
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                ...
                <!-- ============================================== SKIP BRAND 1   PRODUCTS : START ============================================== -->
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'vietnamese')
                            {{ $skipBrand1->brand_name_vn }}
                        @else
                            {{ $skipBrand1->brand_name_en }}
                        @endif
                    </h3>
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
